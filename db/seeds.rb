...
Instrument.create!([{
    ...
    :finish => "Red",
    :price => "2999",
    :image => Rails.root.join("public/images/instrument1.jpg").open,
    :user_id => user.id
},
{
  ...
  :finish => "Red",
  :price => "2595",
  :image => Rails.root.join("public/images/instrument2.jpg").open,
  :user_id => user.id
},
{
  ...
  :finish => "Seafoam",
  :price => "2845",
  :image => Rails.root.join("public/images/instrument3.jpg").open,
  :user_id => user.id
},
{
  ...
  :finish => "Clear",
  :price => "960",
  :image => Rails.root.join("public/images/instrument4.jpg").open,
  :user_id => user.id
},
{
  ...
  :finish => "Red",
  :price => "599",
  :image => Rails.root.join("public/images/instrument5.jpg").open,
  :user_id => user.id
},
{
  ...
  :finish => "Yellow",
  :price => "799",
  :image => Rails.root.join("public/images/instrument6.jpg").open,
  :user_id => user.id
}
]
